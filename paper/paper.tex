...
The \picalc{} \todo{cite} models concurrent processing by boiling down concurrent interaction to the transmission of data over communication channels --- where channels too are sent as payload.
...
To do so we can either ask the user for type annotations \todo{cite}, or we can synthesize types by looking at how channels are used.
