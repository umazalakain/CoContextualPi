...
un-constr¹ : (t : γ ⊢= k) → Σ[ c ∈ Constr γ ] (∀ {δ} (σ : FreeSubst γ δ) → ⟦ σ <|ᶜ¹ c ⟧ᶜ¹ → +-un (σ <| t))
...
⊢-∶-assoc σ₁ σ₂ t p = p
  ...
  where open import Function.Reasoning using () renaming (_|>_ to _|>>_)
